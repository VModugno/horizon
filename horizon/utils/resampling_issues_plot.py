...
ms = mat_storer.matStorer('resampling_issues_50.mat')
solution = ms.load()
...
if replay_traj:
    ...
    repl = replay_trajectory(dt_res, joint_names, solution['q_res'], f_list_refined_res, cas_kin_dyn.CasadiKinDyn.LOCAL_WORLD_ALIGNED, kindyn)
    repl.sleep(1.)
    repl.replay(is_floating_base=True)
